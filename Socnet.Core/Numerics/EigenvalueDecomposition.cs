namespace Socnet.Core.Numerics
{
    /// <summary>
    /// Eigenvalues of a real (non-symmetric) square matrix, via reduction to Hessenberg form and the
    /// shifted QR algorithm. Used to group blockimage varieties by their spectrum, so that varieties are
    /// numbered exactly as in earlier versions of Socnet.se.
    ///
    /// The numerical code is taken (unchanged) from DotNetMatrix by Paul Selormey, which in turn is a port
    /// of the public domain JAMA library. See:
    /// https://www.codeproject.com/Articles/5835/DotNetMatrix-Simple-Matrix-Library-for-NET
    /// </summary>
    internal sealed class EigenvalueDecomposition
    {
        private readonly int n;
        private readonly double[] d, e;
        private readonly double[][] V;
        private readonly double[][] H;
        private readonly double[] ort;

        /// <summary>
        /// Computes the eigenvalues of the square matrix A (A is not modified).
        /// </summary>
        ...
        //internal Dictionary<string, DataStructure> GetReturnStructures(ActorSet actorset)
        //{
